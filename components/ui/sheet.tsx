  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={{
          paddingTop: (side === 'right' || side === 'left') ? 'env(safe-area-inset-top)' : undefined,
          paddingBottom: (side === 'right' || side === 'left') ? 'env(safe-area-inset-bottom)' : undefined,
          paddingLeft: side === 'right' ? undefined : 'env(safe-area-inset-left)',
          paddingRight: side === 'left' ? undefined : 'env(safe-area-inset-right)',
      ...
      >
        ...
        <SheetPrimitive.Close 
          ...
          style={{
            top: (side === 'right' || side === 'left') ? 'max(1rem, env(safe-area-inset-top))' : '1rem',
          }}
        >
