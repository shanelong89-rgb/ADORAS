    ...
    >
      ...
      <div 
        ...
        style={{ 
          ...
          paddingBottom: `calc(${inputBoxHeight}px + env(safe-area-inset-bottom, 0px) + 48px)`,
          flex: '1 1 0',
          minHeight: 0
        }}
      >
        <div 
          className={`space-y-4 max-w-full px-3 pb-16 ${activePrompt || currentPromptContext ? 'pt-4' : 'pt-0'}`}
          style={{ 
            overflow: 'visible'
          }}
        >
